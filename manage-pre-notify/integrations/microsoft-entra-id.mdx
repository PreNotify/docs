...
## Setting Up Microsoft Entra ID Device Integration

In PreNotify, go to “Integrations” and click on the Microsoft Entra ID integration, then "Edit" to configure the integration.
